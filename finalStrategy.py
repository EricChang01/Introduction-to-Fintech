class Strategy():
    ...
    def trade(self, information):
        ...
        # price increase after buying (sell)
        ...
        # cross down (do nothing or can decrease benefit)
